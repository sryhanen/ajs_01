...
describe('Commit paragraph request unit test', () => {
  ...
  let commitParagraphRequest: RequestMessage;

  beforeEach(() => {
    requestable = new FakeChannel();
    commitParagraphRequest = new CommitParagraphRequest(requestable, paragraphData);
  });
