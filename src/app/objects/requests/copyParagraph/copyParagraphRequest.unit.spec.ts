...
import {CopyParagraphRequest} from './copyParagraphRequest';

describe('Copy paragraph request unit test', () => {
  ...
  const index = 1;
  let copyParagraphRequest: RequestMessage;

  beforeEach(() => {
    requestable = new FakeChannel();
    copyParagraphRequest = new CopyParagraphRequest(requestable, index, paragraphData);
  });
