...
import {HideEditorButton} from './hideEditorButton';

describe('HideEditorButton functional test', () => {
  ...
  let channel: Channel;
  let fixture: ComponentFixture<HideEditorButton>;

  beforeEach(async () => {
    channel = new FakeChannel();
    paragraph = new ParagraphImpl(channel, paragraphProperties);
    const renderResult = await render(HideEditorButton, {
      inputs:{
        paragraph: paragraph
      }
    });
