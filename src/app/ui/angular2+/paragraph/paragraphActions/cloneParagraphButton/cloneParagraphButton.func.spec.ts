...
import {CloneParagraphButton} from './cloneParagraphButton';

describe('CloneParagraphButton functional test', () => {
  ...
  let channel: Channel;
  let fixture: ComponentFixture<CloneParagraphButton>;

  beforeEach(async () => {
    channel = new FakeChannel();
    paragraph = new ParagraphImpl(channel, paragraphProperties);
    const renderResult = await render(CloneParagraphButton, {
      inputs:{
        paragraph: paragraph
      }
    });
