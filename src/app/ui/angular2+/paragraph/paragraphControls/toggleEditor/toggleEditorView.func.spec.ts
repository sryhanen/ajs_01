...
import {ToggleEditorView} from './toggleEditorView';
import {fireEvent, render, screen} from '@testing-library/angular';
import {FakeChannel} from '../../../../../objects/channel/fakeChannel';

describe('ToggleEditorView functional test', () => {
  let fixture: ComponentFixture<ToggleEditorView>;
  ...
  beforeEach(async () => {
    ...
    const renderResult = await render(ToggleEditorView,{
      inputs:{
