...
describe('JobManagerComponent', () => {
  ...
  const jobManagerSrvMock = {
    getJobs: function (){},
    subscribeSetJobs: function (){},
    subscribeUpdateJobs: function (){},
    disconnect: function (){},
  };
  ...
  it('should set jobs using `setJobs`', () => {
    const ctrl = $controller('JobManagerCtrl', {$scope: $scope, JobManagerService: jobManagerSrvMock});
