...
function vizPiechartService(
  vizRegisterService,
) {

  const self = this;
  self.inclusion = '/app/notebook/paragraph/result/piechart/piechart.html';
  self.controllerName = 'PiechartCtrl';
  ...
  self.id = 'pieChart';
  self.name = 'Pie Chart';
  self.buttonIcon = '<i class="fas fa-chart-pie"></i>';
