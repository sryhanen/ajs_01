...
import PiechartVisualization from './visualization-piechart';

angular.module('zeppelinWebApp.vizPiechart')
  ...
  */
  ...
  $scope.initViz = function (element) {
    ...
    if(!viz) {
      ...
      element[0].id = vizID;
      viz = new PiechartVisualization(element, $scope.vizConfig);
      viz.render(transformed);
