...
function vizNetworkService(
  vizRegisterService,
) {

  const self = this;
  self.inclusion = '/app/notebook/paragraph/result/network/network.html';
  self.controllerName = 'NetworkCtrl';
  ...
  self.id = 'network';
  self.name = 'Network';
  self.buttonIcon = '<i class="fas fa-share-alt"></i>';
