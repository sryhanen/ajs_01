 ...
 */
describe('Module Controller: HTML', function() {
  beforeEach(angular.mock.module('zeppelinWebApp.vizHTML'));
  ...
  beforeEach(angular.mock.inject(
    function(
      ...
      controller = $controller('HTMLCtrl', {
        $scope: scope,
        $compile: compile,
  ...
  it('viz should init and refresh correctly', function() {
    ...
    expect(elementMock.html()).toEqual('<div><b>test</b></div>');
    const refreshData = '<div><b>this_content_was_refreshed</b></div>';
    storage.refresh(refreshData);
    expect(elementMock.html()).toEqual('<div><b>this_content_was_refreshed</b></div>');
  });
