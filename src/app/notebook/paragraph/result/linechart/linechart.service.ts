...
function vizLinechartService(
  vizRegisterService,
) {

  const self = this;
  self.inclusion = '/app/notebook/paragraph/result/linechart/linechart.html';
  self.controllerName = 'LinechartCtrl';
  ...
  self.buttonIcon = '<i class="fas fa-chart-line"></i>';
