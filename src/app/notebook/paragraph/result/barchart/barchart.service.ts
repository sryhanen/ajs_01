...
function vizBarchartService(
  vizRegisterService,
) {

  const self = this;
  self.inclusion = '/app/notebook/paragraph/result/barchart/barchart.html';
  self.controllerName = 'BarchartCtrl';

  self.hasSettings = true;
  self.compatibleList = [
    DisplayType.TABLE,
  ];
  self.id = 'multiBarChart';
  self.name = 'Bar Chart';
  self.buttonIcon = '<i class="fas fa-chart-bar"></i>';
