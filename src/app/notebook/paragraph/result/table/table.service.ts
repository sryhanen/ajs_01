...
function vizTableService(
  vizRegisterService,
) {

  const self = this;
  self.inclusion = '/app/notebook/paragraph/result/table/table.html';
  self.controllerName = 'TableCtrl';
  ...
  self.id = 'table';
  self.name = 'Table';
  self.buttonIcon = '<i class="fas fa-table"></i>';
