...
function vizAreachartService(
  vizRegisterService,
) {

  const self = this;
  self.inclusion = '/app/notebook/paragraph/result/areachart/areachart.html';
  self.controllerName = 'AreachartCtrl';

  self.hasSettings = true;
  self.compatibleList = [
    DisplayType.TABLE,
  ];
  self.id = 'stackedAreaChart';
  self.name = 'Area Chart';
  self.buttonIcon = '<i class="fas fa-chart-area"></i>';
